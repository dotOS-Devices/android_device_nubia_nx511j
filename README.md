...
P.S. After "lunch", check the availability of repositories in your work directory, specified in dot.dependencies, and add them manually, if they are missing.
